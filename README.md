...
- [環境情報](doc/01_設計資料/ENVIRONMENT.md) - 開発環境の詳細情報
- [アーキテクチャ](doc/01_設計資料/ARCHITECTURE.md) - Docker構成図とシステムアーキテクチャ
- [セットアップ手順](doc/01_設計資料/SETUP.md) - 初期セットアップと日常的な開発フロー
- [注意ポイント](doc/01_設計資料/NOTES.md) - セキュリティや開発上の重要事項
- [開発ツール](doc/98_ツール/README.md) - 開発効率化ツールの使用方法
...
- ✅ ポート競合を自動チェック
- ✅ プロセス監視機能付き（異常終了を自動検知）
- ✅ ログのローテーション機能
- ✅ グレースフルシャットダウン対応

**停止方法**:
- **同じターミナルから**: `Ctrl + C`
- **別のターミナルから**: `./doc/98_ツール/stop-dev.sh`
...
**詳細情報**: [開発ツールドキュメント](doc/98_ツール/README.md)
...
効率的な開発のために、自動化スクリプトを提供しています。

### 🚀 start-dev.sh - 開発環境一括起動

バックエンドとフロントエンドを1つのコマンドで起動します。
...
**主な機能**:
- バックエンド（FastAPI）とフロントエンド（Vite）の同時起動
- プロセス監視（異常終了時に自動検知）
- ログのローテーション機能（最大10MB）
- ポート使用状況の事前チェック
- グレースフルシャットダウン対応
...
**動作**:
- バックエンドとフロントエンドをグレースフルシャットダウン
- PIDファイルの自動クリーンアップ
- タイムアウト時は強制終了（10秒）

### 📚 詳細情報

開発ツールの詳細な使用方法やトラブルシューティングについては、[開発ツールドキュメント](doc/98_ツール/README.md)を参照してください。

### 詳細なドキュメント

より詳細な情報は以下のドキュメントを参照してください:

- [セットアップ手順書](doc/01_設計資料/SETUP.md) - 初期セットアップと詳細な設定
- [環境情報](doc/01_設計資料/ENVIRONMENT.md) - 開発環境の詳細情報
- [アーキテクチャ](doc/01_設計資料/ARCHITECTURE.md) - システムアーキテクチャ
- [注意ポイント](doc/01_設計資料/NOTES.md) - セキュリティや開発上の重要事項
- [開発ツール](doc/98_ツール/README.md) - 開発効率化ツールの詳細
...
│   ├── 01_設計資料/     # アーキテクチャ、セットアップ、環境情報
│   ├── 98_ツール/       # 開発効率化ツール（start-dev.sh, stop-dev.sh）
│   └── 99_プロンプト/   # AI支援用プロンプト
...
詳細は[環境情報ドキュメント](doc/01_設計資料/ENVIRONMENT.md#データベーススキーマ)を参照してください。
